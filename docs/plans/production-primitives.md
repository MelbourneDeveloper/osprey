...
| 5 | List patterns (`[head, ...tail]`) | ❌ already deferred — see Phase 5 of [`collections.md`](collections.md) — escalated to critical-path | [`collections.md`](collections.md#phase-5--pattern-matching) |
...
The four plans are **independent at the implementation level** but have a natural priority order if a single agent picks them up:
...
## Master TODO (across all four plans)
