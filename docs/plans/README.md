...
| [0010](0010-cross-language-benchmark-suite.md) | Cross-language benchmark suite | benchmarks | 15 cases × 5 langs shipped; feature-blocked classics (need integer `/`, arrays, float) pending | Low–High |
