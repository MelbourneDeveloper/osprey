...
4. **No silent Unicode surprises.** Case conversion follows Unicode simple case mapping; lengths are codepoint counts, not byte counts. This matches Haskell `Data.Text` and Elm `String`.
