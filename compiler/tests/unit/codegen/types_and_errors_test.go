...
func TestMoreErrorWrappers(t *testing.T) {
	...
	cases := []struct {
		...
		{"FunctionRequiresNamedArgsWithPos", codegen.WrapFunctionRequiresNamedArgsWithPos("foo", 2, pos), "foo"},
		{"FunctionRequiresNamedArgsWithPosNil", codegen.WrapFunctionRequiresNamedArgsWithPos("foo", 2, nil), "foo"},
