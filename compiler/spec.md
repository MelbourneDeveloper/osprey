...
- [17. Built-in Functions Reference](#17-built-in-functions-reference)
  - [17.1 Basic I/O Functions](#171-basic-io-functions)
    - [`print(value: int | string | bool) -> int`](#printvalue-int--string--bool---int)
    - [`input() -> int`](#input---int)
    - [`toString(value: int | string | bool) -> string`](#tostringvalue-int--string--bool---string)
    - [`length(s: string) -> Result<int, StringError>`](#lengths-string---resultint-stringerror)
    - [`contains(haystack: string, needle: string) -> Result<bool, StringError>`](#containshaystack-string-needle-string---resultbool-stringerror)
    - [`substring(s: string, start: int, end: int) -> Result<string, StringError>`](#substrings-string-start-int-end-int---resultstring-stringerror)
  - [17.2 File System Functions](#172-file-system-functions)
    - [`writeFile(path: string, content: string) -> Result<Success, string>`](#writefilepath-string-content-string---resultsuccess-string)
    - [`readFile(path: string) -> Result<string, string>`](#readfilepath-string---resultstring-string)
    - [`deleteFile(path: string) -> Result<Success, string>`](#deletefilepath-string---resultsuccess-string)
    - [`createDirectory(path: string) -> Result<Success, string>`](#createdirectorypath-string---resultsuccess-string)
    - [`fileExists(path: string) -> bool`](#fileexistspath-string---bool)
  - [17.3 Process Operations](#173-process-operations)
    - [`spawnProcess(command: string, callback: fn(int, int, string) -> Unit) -> Result<ProcessResult, string>`](#spawnprocesscommand-string-callback-fnint-int-string---unit---resultprocessresult-string)
    - [`awaitProcess(processId: int) -> int`](#awaitprocessprocessid-int---int)
    - [`cleanupProcess(processId: int) -> void`](#cleanupprocessprocessid-int---void)
  - [17.2 Functional Iterator Functions](#172-functional-iterator-functions)
  ...
  - [17.3 Pipe Operator](#173-pipe-operator)
    - [`|>` - Pipe Operator](#---pipe-operator)
  - [17.4 Functional Programming Patterns](#174-functional-programming-patterns)
    - [Chaining Pattern](#chaining-pattern)
    - [Side Effect Pattern](#side-effect-pattern)
    - [Data Transformation Pattern](#data-transformation-pattern)
  - [17.5 Fiber Types and Concurrency](#175-fiber-types-and-concurrency)
    ...
    - [Fiber-Isolated Modules](#fiber-isolated-modules)
